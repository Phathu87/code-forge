...
Version: 0.1.0. Environment: local Windows and isolated Neon integration branch. Date: 2026-09-17. Source revision: use `git rev-parse HEAD` for the checked-out commit. No production artifact, operator sign-off or store submission has been approved.
